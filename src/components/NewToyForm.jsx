    ...
    return (
        <div>
            ...
            <form style={{marginTop:"15px", marginBottom:"15px"}}>
                    ...
                    <div style={{marginBottom:"10px"}}><input type="text" name="titre" required style={{backgroundColor:"#e2dfbc", color:"black", width:"300px", height:"50px", borderRadius:"3px"}}/></div>
                    <div style={{textAlign:"left", marginLeft:"35px", fontSize:"1.5rem"}}><label for="description">Description</label>{'  '}</div>
                    <div style={{marginBottom:"10px"}}><input type="textarea" name="description" required style={{backgroundColor:"#e2dfbc", color:"black", width:"300px", borderRadius:"3px"}}/></div>
                    <div style={{textAlign:"left", marginLeft:"35px", fontSize:"1.5rem"}}><label for="price" required>Prix en euros</label>{'  '}</div>
                    <div style={{marginBottom:"10px"}}><input type="number" name="price" style={{backgroundColor:"#e2dfbc", color:"black", width:"300px", borderRadius:"3px"}}/></div>     
            </form>
